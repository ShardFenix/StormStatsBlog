...
The difference in quality of replay data suggests that the later maps were made by some dudes who had no clue what they were doing. I would bet Blizzard sexually harassing some interns, then told them it would be fun for them to cobble together a map or two for this dead game. The design of these maps is bad, by the way. They are two of the worst three maps in the pool.
